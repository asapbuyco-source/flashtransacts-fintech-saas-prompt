      ...
      >
        <div className="glass rounded-2xl p-8 border-glow">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-text-secondary">Create your account, then contact admin to activate server access</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2 text-sm">
              <input type="checkbox" className="w-4 h-4 rounded accent-gold mt-0.5" required />
              <span className="text-text-secondary text-xs">
                I agree to the <a href="#" className="text-gold hover:underline">Terms of Service</a> and{" "}
